...
import android.car.evsafeservice.IEVSafeServiceManager; ////추가
...
public class CarService extends Service {
    ...
    private IEVSafeServiceManager evSafeService; //// 추가
    ...
    public void onCreate() {
        ...
        ////추가
        Intent intent = new Intent("EVSafeService");
        intent.setPackage("android.car.evsafeservice"); //server package
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            evSafeService = IEVSafeServiceManager.Stub.asInterface(service);
            try {
                int batteryPercentage = evSafeService.getBatteryPercentage();
                Log.d("CarService", "Battery Percentage: " + batteryPercentage);
                // 퍼센티지 결과 처리
            } catch (RemoteException e) {
                e.printStackTrace();
            }
